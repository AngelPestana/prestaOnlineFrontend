...
export class VigilanteAdministradoresSupervisoresPromotoresGuard implements CanActivate {
  ...
  canActivate(
    ...
    if (localStorage.getItem('token') != null && localStorage.getItem('nombre') != null && localStorage.getItem('id_rol') != null && localStorage.getItem('tiempoExpirado') != null) {
      if (localStorage.getItem('id_rol') == '1' || localStorage.getItem('id_rol') == '2' || localStorage.getItem('id_rol') == '3') {
        return true;
      }else {
